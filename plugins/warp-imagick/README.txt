...
Plugin [WP Email Users](https://wordpress.org/plugins/wp-email-users/) (tested with version 1.7.6.) causes fatal submit error when saving Warp-iMagick settings.
